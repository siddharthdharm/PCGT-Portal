...
<% 
   ...
   try {
      ...
      while(rs.next()) {
         staticpowerlocation = rs.getString("rawdata");
      }
      stmt.close(); 
      conn.close();
   ...
   String delete = "cmd /c E: & cd "+staticpowerlocation+" & del /Q staticpower.csv";   
   ...
   if ((contentType.indexOf("multipart/form-data") >= 0)) {
      ...
      factory.setRepository(new File(staticpowerlocation));
      ...
      try{ 
         ...
         while ( i.hasNext () ) 
         {
            ...
            if ( !fi.isFormField () )  
            {
               ...
               if( fileName.lastIndexOf("\\") >= 0 ){
                  file = new File(staticpowerlocation + 
         ...
         String rename = "cmd /c E: & cd "+staticpowerlocation+" & ren \""+fileName2+"\" staticpower.csv";
   ...
   try {
      ...
      String str1 = "DELETE FROM staticpower;";
      String str2 = "LOAD DATA LOCAL INFILE '"+staticpowerlocation+"staticpower.csv' INTO TABLE staticpower FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS;";
